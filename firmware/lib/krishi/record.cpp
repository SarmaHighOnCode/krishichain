...
// Explicit big-endian writers. Do NOT replace these with a struct memcpy: the ESP32 is
// little-endian, the canonical form is big-endian, and struct layout is not portable
// between the native test build and the device build.
